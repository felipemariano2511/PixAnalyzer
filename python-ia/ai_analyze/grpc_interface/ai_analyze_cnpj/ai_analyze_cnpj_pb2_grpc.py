...
class AiAnalyzeCnpjServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AiAnalyzeCnpj = channel.unary_unary(
                '/pixanalyzer.AiAnalyzeCnpjService/AiAnalyzeCnpj',
...
def add_AiAnalyzeCnpjServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'pixanalyzer.AiAnalyzeCnpjService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('pixanalyzer.AiAnalyzeCnpjService', rpc_method_handlers)
